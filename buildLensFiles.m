function [ output_args ] = buildLensFiles( matrix, unitWidth, ports, startFreq, stopFreq, stepFreq, folderName)
...
generateSim_stiFile(startFreq,stopFreq,stepFreq, [folderName, '\', 'proj.sti']);
