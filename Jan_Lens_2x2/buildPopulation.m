function [ matrix ] = buildPopulation( initialPopulationSize, M, N, portLocations, percMetal, yaxisSym, xaxisSym)
...
while(x<=initialPopulationSize)
    matrix(:,:,x)=generateRandomMatrix(M,N,portLocations, percMetal,yaxisSym,xaxisSym);
    x=x+1;
end
