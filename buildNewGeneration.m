...
%and children
costPop=calculateCostOfPop(Sparams,Sideal,costWeighting); %calculate the cost of each member
survivingPop=survival(pop,killPercent,costPop); %kill the weak ones
